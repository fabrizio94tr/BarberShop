...
const MOCK_APPOINTMENTS: Appointment[] = [
  ...
  { id: '2', time: '10:00', date: new Date(), duration: '45 min', service: 'Taglio & Barba', customer: 'Luca Romano', phone: '328 9876543', status: 'confirmed', notes: 'Il cliente ha chiesto di spostare alle 10:15 se possibile.' },
  { id: '3', time: '11:30', date: new Date(), duration: '30 min', service: 'Regolazione Barba', customer: 'Ospite (Giovanni)', phone: '340 1122334', status: 'confirmed', isWalkIn: true, notes: 'Non si è presentato la volta scorsa.' },
