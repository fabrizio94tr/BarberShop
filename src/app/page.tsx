...
const DUMMY_LOCATIONS = [
  { id: '1', name: 'Barber & Co. - Prati', address: 'Via Cola di Rienzo, 12', price: 'da €25', image: '/shop_1.png' },
  { id: '2', name: 'Barber & Co. - Trastevere', address: 'Piazza Trilussa, 5', price: 'da €30', image: '/shop_2.png' },
  { id: '3', name: 'Barber & Co. - Parioli', address: 'Viale dei Parioli, 44', price: 'da €35', image: '/shop_3.png' },
  { id: '4', name: 'Barber & Co. - EUR', address: 'Viale Europa, 110', price: 'da €25', image: '/shop_1.png' },
  { id: '5', name: 'Barber & Co. - Centro Storico', address: 'Via del Corso, 200', price: 'da €40', image: '/shop_2.png' },
  { id: '6', name: 'Barber & Co. - Testaccio', address: 'Via Galvani, 3', price: 'da €20', image: '/shop_3.png' },
]
...
export default async function Home() {
  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center p-6 sm:p-24 text-white">
      ...
      />
      <div className="absolute inset-0 z-0 bg-black/80 backdrop-blur-[2px]" /> {/* Overlay scuro per leggibilità */}
      ...
      <div className="z-10 max-w-6xl w-full flex flex-col gap-12">
        <nav className="flex justify-between items-center">
          <div className="flex items-center gap-2">
            ...
            <span className="font-bold tracking-widest text-xl">BARBER & CO.</span>
          </div>
        ...
        <div className="flex flex-col gap-8 mt-12 md:mt-24">
          <div className="space-y-6">
            <h1 className="text-5xl md:text-7xl lg:text-[5.5rem] font-bold tracking-tighter max-w-4xl leading-[0.9] text-white">
              ...
              >
                ...
                <div className="relative z-20 p-8 flex flex-col justify-between h-full">
                  ...
                  <div className="mt-auto">
                    <h3 className="text-3xl font-bold mb-2 text-white tracking-tight">{loc.name}</h3>
                    <p className="text-sm text-gray-300 mb-8 font-light">{loc.address}</p>
                    
                    <Link href={user ? `/book/${loc.id}` : '/login'}>
                      <Button className="w-full justify-between h-14 bg-white/10 backdrop-blur-md border border-white/20 text-white hover:bg-white hover:text-black transition-all group-hover:bg-white group-hover:text-black rounded-xl">
                        <span className="font-semibold text-base">Prenota ora</span>
